...
export const events: TradeEvent[] = [
  // ===== UPCOMING =====
  {
    ...
    type: 'trade-mission',
    description:
      "A full-week Italy–Nigeria business immersion in the heart of the Veneto Region. From boardrooms in Treviso to factory floors across Italy's food-innovation belt, Nigerian delegates step directly into Europe's most advanced agri-food ecosystem — meeting policymakers, signing partnerships, touring production lines, and walking out with real export deals, new technology and bankable opportunities. Organised by Desk Africa Medio Oriente in partnership with Innofood SRL, with Nigerian delegate coordination by Dauno Integrated Ltd.",
    date: '2026-07-13',
    endDate: '2026-07-19',
    location: 'Treviso & Veneto Region, Italy',
    highlights: [
      '6 days of curated B2B meetings with vetted Italian companies',
      'Private factory tours across the Veneto food-innovation belt',
      'Think-tank access to Desk Africa Medio Oriente decision-makers',
      'Direct route to European market entry & SME financing',
      'Cultural programme in Treviso & Venice',
    ],
    focusAreas: ['Agriculture', 'Food Processing', 'Packaging Technology', 'Export Development', 'Logistics & Distribution'],
    outcomes: [
      'Signed MOUs and strategic Nigeria–Italy partnerships',
      'New export channels into the EU market',
      'Technology & knowledge transfer for Nigerian SMEs',
      'Investment leads for agribusiness & food-processing ventures',
      'A standing Italy–Nigeria business corridor',
    ],
    organizers: ['Desk Africa Medio Oriente', 'Innofood SRL', 'Dauno Integrated Ltd'],
    shareTagline: '🇮🇹🤝🇳🇬 One week in Italy. A lifetime of trade. Join the Italy–Nigeria B2B Mission · 13–19 July 2026 · Treviso.',
    agenda: [
      { day: 'Sun 12 Jul', time: '—', title: 'Arrival at Venice Marco Polo Airport + welcome briefing & orientation' },
      { day: 'Mon 13 Jul', time: '09:30', title: 'Day 1 — Opening at INNO FOOD SRL: "Global Food Innovation & Sustainability"' },
      { day: 'Mon 13 Jul', time: '13:00', title: 'Networking lunch & first B2B introductions' },
      { day: 'Mon 13 Jul', time: '14:30', title: 'B2B matchmaking with policymakers & industry experts' },
      { day: 'Tue 14 Jul', time: '09:30', title: 'Day 2 — One-on-one B2B meetings: Nigerian × Italian companies' },
      { day: 'Tue 14 Jul', time: '11:30', title: 'Export opportunities & matchmaking sessions' },
      { day: 'Tue 14 Jul', time: '14:30', title: 'SME partnerships + entrepreneurship & skills exchange' },
      { day: 'Wed 15 Jul', time: '09:00', title: 'Day 3 — Industrial visits: food production & processing across the Veneto Region' },
      { day: 'Wed 15 Jul', time: '14:00', title: 'Technical tours: packaging tech, sustainable agriculture, supply-chain systems' },
      { day: 'Thu 16 Jul', time: '09:30', title: 'Day 4 — Innovation Think Tank: future food systems' },
      { day: 'Thu 16 Jul', time: '14:00', title: 'Access to European markets + SME & agribusiness financing pathways' },
      { day: 'Fri 17 Jul', time: '10:00', title: 'Day 5 — Cultural & business tour of Treviso and Venice' },
      { day: 'Sat 18 Jul', time: '10:00', title: 'Day 6 — Closing session, MOUs, certificates & departures' },
    ],
    speakers: [
    ...
    sponsors: ['Innofood SRL', 'Desk Africa Medio Oriente', 'Dauno Integrated Ltd'],
    ticketTiers: [
      { tier: 'free', price: 0, label: 'Standard Delegate Pass', perks: ['Full B2B meeting access', 'All matchmaking sessions', 'Networking lunches', 'Industrial visits', 'Event materials'] },
      { tier: 'vip', price: 250, label: 'VIP Delegate Pass', perks: ['Priority B2B matchmaking', 'Reserved seating', 'Private meeting room', 'Closing cocktail & gala', 'Direct intro to Desk Africa think tank'] },
    ],
  ...
  },
  {
    ...
    tagline: 'Connect the World · Shape the Future — Nigeria delegation to the premier Belt & Road platform',
    type: 'conference',
    description:
      "The Belt and Road Summit is the premier international platform for capturing business opportunities along the Belt and Road. Jointly organised by the Government of the Hong Kong SAR and the Hong Kong Trade Development Council, the Summit gathers senior government officials and prestigious business leaders from 70+ countries and regions to exchange insights on multilateral collaboration and explore investment opportunities. In 2025, the 10th edition drew 6,200+ participants, 300+ investment projects from 50+ countries, 800+ one-to-one deal-making meetings and 45 MOUs signed. Dauno Integrated Ltd is mobilising a Nigerian delegation for the 2026 edition — a 4-day, 3-night fully coordinated mission to Hong Kong covering thematic sessions, signature project showcases, deal-making meetings, B2B introductions, investment sessions and exhibition zones.",
    date: '2026-09-09',
    endDate: '2026-09-10',
    location: 'Hong Kong Convention and Exhibition Centre, Hong Kong SAR',
    highlights: [
      '6,200+ participants and 70+ countries represented in 2025',
      '800+ pre-arranged one-to-one deal-making meetings',
      '300+ investment projects from 50+ countries',
      'Access to signature Belt and Road infrastructure projects',
      'Exhibition zones: Global Investment, Hong Kong, InnoTech & ASEAN Pavilion',
      '4-day, 3-night luxury hotel stay with Nigerian delegation',
    ],
    focusAreas: [
    ...
    outcomes: [
      'Direct exposure to global project owners, investors and service providers',
      'Pre-arranged matchmaking with potential partners along the Belt & Road',
      'New investment leads and signed MOUs for Nigerian businesses',
      'Strategic positioning of Nigeria within the Belt & Road corridor',
      'Knowledge transfer through thematic breakout & policy dialogue sessions',
    ],
    organizers: [
    ...
    shareTagline: '🇭🇰 Hong Kong · 9–10 Sept 2026 · Join the Nigerian delegation to the Belt and Road Summit — Connect the World, Shape the Future.',
    agenda: [
      { day: 'Tue 8 Sep', time: '—', title: 'Day 1 — Arrival in Hong Kong & hotel check-in' },
      { day: 'Wed 9 Sep', time: '09:00', title: 'Day 2 — Opening Session & Keynote Speeches' },
      { day: 'Wed 9 Sep', time: '11:00', title: 'Policy Dialogue & Business Plenary' },
      { day: 'Wed 9 Sep', time: '13:00', title: 'Keynote Luncheon & Networking' },
      { day: 'Wed 9 Sep', time: '14:30', title: 'Thematic Breakout Sessions & Investment Sessions' },
      { day: 'Wed 9 Sep', time: '16:00', title: 'Exhibition Zones: Global Investment, Hong Kong, InnoTech & ASEAN Pavilion' },
      { day: 'Thu 10 Sep', time: '09:30', title: 'Day 3 — Signature Belt and Road Projects Sessions' },
      { day: 'Thu 10 Sep', time: '11:00', title: 'One-to-One Deal-Making Meetings & B2B Matchmaking' },
      { day: 'Thu 10 Sep', time: '14:00', title: 'Finance Chapter · Green Chapter · Youth Chapter' },
      { day: 'Thu 10 Sep', time: '17:00', title: 'Closing Reception & Networking' },
      { day: 'Fri 11 Sep', time: '—', title: 'Day 4 — Hotel check-out & departure to home country' },
    ],
    speakers: [
      { name: 'The Hon John KC Lee, GBM, SBS, PDSM, PMSM', role: 'Chief Executive', company: 'Hong Kong SAR, People\u2019s Republic of China' },
      { name: 'The Hon Paul Chan Mo-po, GBM, GBS, MH, JP', role: 'Financial Secretary', company: 'Government of the Hong Kong SAR' },
      { name: 'Professor Frederick S Ma, GBS, JP', role: 'Chairman', company: 'Hong Kong Trade Development Council' },
      { name: 'Mr Yan Dong', role: 'Vice Minister', company: 'Ministry of Commerce, People\u2019s Republic of China' },
      { name: 'H.E. Sun Chanthol', role: 'Deputy Prime Minister', company: 'Council for the Development of Cambodia' },
      { name: 'YB Anthony Loke', role: 'Minister of Transport', company: 'Malaysia' },
      { name: 'H.E. Dr Ahmed bin Mohammed Al-Sayed', role: 'Minister of State for Foreign Trade Affairs', company: 'State of Qatar' },
      { name: 'Mr Khaled Al Khattaf', role: 'Chief Executive Officer', company: 'Saudi Investment Promotion Authority' },
      { name: 'Ms Gim Huay Neo', role: 'Managing Director, Managing Board Member', company: 'World Economic Forum' },
    ],
    sponsors: ['HKTDC', 'Government of the Hong Kong SAR', 'Dauno Integrated Ltd'],
    ticketTiers: [
      { tier: 'free', price: 0, label: 'Nigerian Delegate Pass — Register Interest', perks: ['Full Summit access', '4-day, 3-night luxury hotel stay', 'Deal-making & B2B matchmaking sessions', 'Exhibition zones access', 'Visa invitation letter available on request'] },
    ],
    registrations: 0, capacity: 60, isPast: false,
    imageUrl: '/images/events/belt-road-summit-hk.jpg',
  },
  {
