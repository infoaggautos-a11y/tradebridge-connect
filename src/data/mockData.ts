...
export const events: TradeEvent[] = [
  // ===== UPCOMING =====
  {
    ...
    highlights: [
      ...
      'Factory & production tours across the Veneto Region',
      'Access to European markets and SME financing pathways',
      'MOUs, certificates and bankable partnership outcomes',
      'Cultural & business immersion in Treviso and Venice',
    ],
    outcomes: [
      'Strengthened Nigeria–Italy business relationships',
      'Increased trade and export opportunities',
      'Strategic partnerships in agriculture and food production',
      'Knowledge transfer and technology exchange',
      'Investment opportunities for SMEs and agribusiness sectors',
    ],
    organizers: ['Desk Africa Medio Oriente', 'Innofood SRL', 'Dauno Integrated Ltd'],
    shareTagline: '🇮🇹🤝🇳🇬 One week in Italy. A lifetime of trade. Join the Italy–Nigeria B2B Mission · 8–15 September 2026 · Treviso.',
    agenda: [
      { day: 'Mon 7 Sep', time: '—', title: 'Arrival at Venice Marco Polo Airport + welcome briefing & orientation' },
      { day: 'Tue 8 Sep', time: '09:30', title: 'Day 1 — Opening at INNO FOOD SRL: "Global Food Innovation & Sustainability"' },
      { day: 'Tue 8 Sep', time: '13:00', title: 'Networking lunch & first B2B introductions' },
      { day: 'Tue 8 Sep', time: '14:30', title: 'B2B matchmaking with policymakers & industry experts' },
      { day: 'Wed 9 Sep', time: '09:30', title: 'Day 2 — One-on-one B2B meetings: Nigerian × Italian companies' },
      { day: 'Wed 9 Sep', time: '11:30', title: 'Export opportunities & matchmaking sessions' },
      { day: 'Wed 9 Sep', time: '14:30', title: 'SME partnerships + entrepreneurship & skills exchange' },
      { day: 'Thu 10 Sep', time: '09:00', title: 'Day 3 — Industrial visits: food production & processing across the Veneto Region' },
      { day: 'Thu 10 Sep', time: '14:00', title: 'Technical tours: packaging tech, sustainable agriculture, supply-chain systems' },
      { day: 'Fri 11 Sep', time: '09:30', title: 'Day 4 — Innovation Think Tank: future food systems' },
      { day: 'Fri 11 Sep', time: '14:00', title: 'Access to European markets + SME & agribusiness financing pathways' },
      { day: 'Sat 12 Sep', time: '10:00', title: 'Day 5 — Cultural & business tour of Treviso and Venice' },
